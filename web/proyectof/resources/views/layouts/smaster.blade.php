    ...
    <header class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
              <a class="navbar-brand" href="#"> <img src="{{asset('img/icono.png')}}" class="logo animate__animated animate__swing"> ElefanteAzull</a>
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
              </button>
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                  <a class="nav-link " aria-current="page" href="{{route('principal')}}">Catalogo</a>
                 ...
                 <!-- <a class="nav-link " href="{{route('ver_admin')}}" >Ver Admin</a>-->
                  ...
                  <a class="nav-link " href="{{route('principal2')}}" >Salir</a>
                </div>
              </div>
            </div>
          </nav>
