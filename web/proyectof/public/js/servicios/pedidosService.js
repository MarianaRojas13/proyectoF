...
const obtenerPedido =async(id)=>{
    ...
    try{
        ...
        if(resp.status == 200){
            ...
            +'      <div class="form-group mb-3">'
            +'            <label>Fecha </label>'
            +'              <input type="date" class="form-group" value="'+resp.data.fecha+'">'
            +'       </div>'
            +'      <div class="form-group mb-3 ">'
            +'            <label>Nombre productos </label>'
            +'                <input type="text-center" class="form-group" value="'+resp.data.prodN+'">'
            +'       </div>'
            +'      <div class="form-group mb-3">'
            +'            <label>Cantidad </label>'
            +'              <input type="number" class="form-group" value="'+resp.data.cantidad+'">'
            +'       </div>'
            +'      <div class="form-group mb-3">'
            +'            <label>Tipo </label>'
